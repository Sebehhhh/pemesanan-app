    ...
    <div id="auth">
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form action="<?= base_url('register') ?>" method="post">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" name="password_confirm" class="form-control form-control-xl" placeholder="Confirm Password" required>
                            <div class="form-control-icon">
                                <i class="bi bi-shield-lock"></i>
                            </div>
                        </div>
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right">
                    <!-- Tambahkan konten atau gambar di sini sesuai kebutuhan -->
                </div>
            </div>
        </div>
    </div>
